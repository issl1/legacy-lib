 ...
 *
 */
public class ReadFileFromDistrictParam {
	...
	public static void main(String[] args) {
		try {
			 PrintWriter out = new PrintWriter("/home/buntha.chea/WORK/Document/District.txt");//Path to put new file (.txt)
			 File excel =  new File ("/home/buntha.chea/WORK/Project/GLF_Thai_New/nkr-efinance-th/trunk/doc/From Customer/Parameters/Parameter & System Config.xlsx");
		        ...
		        XSSFSheet ws = wb.getSheet("PARAM_DISTRICT");
		        ...
		        for (int i = 0; i <rowNum; i++) {
                    ...
                    String proId = cellProId.toString().replace(".0", "");
                    String disId = celldisId.toString().replace(".0", "");
                    
                    String code = convertCode(i);
                    System.out.println (disId + "," + code + "," + desc + "," + descEn + "," + proId);
                    //insert data to file 
                    out.println("(" + disId + ", '" + code + "'" + ", '" + desc + "'" + ", '" + descEn + "'" + ", " + proId + ", " + 1 + ", " + 1 + ", now()" + ", 'admin'" + ", now()" + ", 'admin'" + ", 'BI'" + ")" + ",");
		        }
		        out.close();
