...
VALUES
(633, 'com.nokor.efinance.core.callcenter.model.ECallCenterResult',        'ECallCenterResult',           'ECallCenterResult',                                  'callcenterresults',    1, true,        true,  true,  false,        true, true, false,      1, now(), 'admin', now(), 'admin');
...
VALUES
-- ECallCenterResult
    (633, 1,  'OK',           'OK',                        'OK',                       null, null, 1, 1, now(), 'admin', now(), 'admin'),
    (633, 2,  'KO',           'KO',                        'KO',                       null, null, 1, 1, now(), 'admin', now(), 'admin'),
    (633, 3,  'OTHER',        'Other',                     'Other',                    null, null, 1, 1, now(), 'admin', now(), 'admin');