 ...
 */
@Entity
@Table(name = "td_task_template_recipient")
public class TaskTemplateRecipient extends EntityWkf implements MTaskRecipient {
	/** */
	private static final long serialVersionUID = -1773596585546357805L;
	 ...
	 * @return
	 */
	public static TaskTemplateRecipient createInstance() {
		TaskTemplateRecipient empTask = EntityFactory.createInstance(TaskTemplateRecipient.class);
        return empTask;
    }
    ...
    @JoinColumn(name="tas_tmp_id", nullable = false)
