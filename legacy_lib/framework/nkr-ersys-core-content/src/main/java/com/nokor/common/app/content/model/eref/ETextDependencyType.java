 ...
 *
 */
public enum ETextDependencyType implements RefDataEntity<DependencyType> {
	 ...
	 * @param def
	 */
	private ETextDependencyType(final EDependencyType def) {
		this.id = def.getId();
	}
     ...
     * 
     */
	private ETextDependencyType(final long id) {
		this.id = id;
	}
