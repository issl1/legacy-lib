...
public class PdfFileBuilder extends FileBuilder {
	...
	/**	 */
	private static final long serialVersionUID = -4979910129467251895L;
    ...
    protected void resetContent() {
    	int nbCols = getNumberofColumns();
    	float largeurPage = 21f / 2.54f;
        document = new Document(PageSize.A4, 25, 25, 75, 50);
        table = new PdfPTable(nbCols);
        table.setTotalWidth(largeurPage);
