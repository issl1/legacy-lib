package com.nokor.frmk.vaadin.ui.paged.constant;

/**
 * Contains the caption of each buttons and separators.
 */
public interface CaptionConstants {
	...
	public static final String CAPTION_SEPARATOR_LAST = CAPTION_SEPARATOR_FIRST;
