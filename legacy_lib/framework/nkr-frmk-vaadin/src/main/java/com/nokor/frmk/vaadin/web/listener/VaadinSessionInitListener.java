package com.nokor.frmk.vaadin.web.listener;
...
public class VaadinSessionInitListener implements SessionInitListener {
    /** */
	private static final long serialVersionUID = -3316357472606257100L;
    ...
    public final void sessionInit(final SessionInitEvent event) throws ServiceException {
        ...
        event.getSession().addBootstrapListener(new BootstrapListener() {
            /** */
			private static final long serialVersionUID = 7493768547448712543L;
