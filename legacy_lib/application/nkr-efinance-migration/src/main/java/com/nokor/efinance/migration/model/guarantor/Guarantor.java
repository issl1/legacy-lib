package com.nokor.efinance.migration.model.guarantor;
...
@Entity
@Table(name = "tm_guarantor")
public class Guarantor extends EntityRefA implements Serializable{
	
	/**
	 */
	private static final long serialVersionUID = 7110165180310308709L;
	
	private Long id;
	private String migrationID;
	private String typeIdNumber;
	 ...
	 */
	public String getTypeIdNumber() {
		return typeIdNumber;
	}
	/**
	 * @param typeIdNumber the typeIdNumber to set
	 */
	public void setTypeIdNumber(String typeIdNumber) {
