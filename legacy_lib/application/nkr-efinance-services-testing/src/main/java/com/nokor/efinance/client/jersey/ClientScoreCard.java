 ...
 * @author uhout.cheng
 */
public class ClientScoreCard extends FinWsClient {
	
	private static final String RSC_LIST = "/configs/credits/scorecards";
	 ...
	 * @return
	 */
	public static Response getScoreCards(String url) {
