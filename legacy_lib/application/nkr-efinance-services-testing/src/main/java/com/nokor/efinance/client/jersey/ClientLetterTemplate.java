 ...
 *
 */
public class ClientLetterTemplate extends FinWsClient {
	
	private static final String RSC_LIST = "/configs/templates/letters";
	private static final String RSC_GET = "/configs/templates/letters/{id}";
