...
/**
 * Asset Plate Number search panel
 * @author uhout.cheng
 */
public class AssetPlateNumberSearchPanel extends AbstractSearchPanel<AssetPlateNumber> implements AssetEntityField {
	...
	/**
	 * 
	 * @param assetPlateNumberTablePanel
	 */
	public AssetPlateNumberSearchPanel(AssetPlateNumberTablePanel assetPlateNumberTablePanel) {
		super(I18N.message("search"), assetPlateNumberTablePanel);
	}
	 ...
	 */
	@Override
	public BaseRestrictions<AssetPlateNumber> getRestrictions() {
		
		BaseRestrictions<AssetPlateNumber> restrictions = new BaseRestrictions<>(AssetPlateNumber.class);
