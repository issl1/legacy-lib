...
/**
 * Asset exterior status search panel
 * @author uhout.cheng
 */
public class AssetExteriorStatusSearchPanel extends AbstractSearchPanel<AssetExteriorStatus> implements AssetEntityField {

	/** */
	private static final long serialVersionUID = -3765002509367775082L;
	...
	/**
	 * 
	 * @param assetExteriorStatusTablePanel
	 */
	public AssetExteriorStatusSearchPanel(AssetExteriorStatusTablePanel assetExteriorStatusTablePanel) {
		super(I18N.message("search"), assetExteriorStatusTablePanel);
	}
	 ...
	 */
	@Override
	public BaseRestrictions<AssetExteriorStatus> getRestrictions() {
		
		BaseRestrictions<AssetExteriorStatus> restrictions = new BaseRestrictions<>(AssetExteriorStatus.class);
