 ...
 *
 */
public class OthersSearchPanel extends AbstractSearchPanel<Dealer> implements DealerEntityField {
	...
	public OthersSearchPanel(OthersTablePanel dealerTablePanel) {
	...
	public BaseRestrictions<Dealer> getRestrictions() {
		...
		restrictions.addCriterion(Restrictions.eq("dealerType", EDealerType.HEAD));
