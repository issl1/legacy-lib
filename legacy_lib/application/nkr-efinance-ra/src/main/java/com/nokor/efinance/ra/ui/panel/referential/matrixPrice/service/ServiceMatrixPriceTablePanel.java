...
public class ServiceMatrixPriceTablePanel extends AbstractTablePanel<AssetMatrixPrice> implements FMEntityField,
		DeleteClickListener, SearchClickListener {

	private static final long serialVersionUID = -3032618904129324322L;
	...
	@Override
	protected ServiceMatrixPriceSearchPanel createSearchPanel() {
		return new ServiceMatrixPriceSearchPanel(this);		
	}
}
