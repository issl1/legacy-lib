 ...
 *
 */
public class DealerGroupSearchPanel extends AbstractSearchPanel<DealerGroup> implements AssetEntityField {
	...
	/**
	 * 
	 * @param dealerGroupTablePanel
	 */
	public DealerGroupSearchPanel(DealerGroupTablePanel dealerGroupTablePanel) {
		super(I18N.message("search"), dealerGroupTablePanel);
	}
	 ...
	 */
	@Override
	public BaseRestrictions<DealerGroup> getRestrictions() {
		
		BaseRestrictions<DealerGroup> restrictions = new BaseRestrictions<>(DealerGroup.class);
