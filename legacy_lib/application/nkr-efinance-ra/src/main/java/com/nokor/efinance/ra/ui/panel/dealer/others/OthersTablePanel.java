...
public class OthersTablePanel extends AbstractTablePanel<Dealer> implements DealerEntityField {
	private static final long serialVersionUID = -2983055467054135680L;
	
		
	@PostConstruct
	public void PostConstruct() {
		setCaption(I18N.message("others"));
		setSizeFull();
		setMargin(true);
		setSpacing(true);
				
		super.init(I18N.message("others"));
	...
	@Override
	protected OthersSearchPanel createSearchPanel() {
		return new OthersSearchPanel(this);		
	}
}
