 ...
 * @author ly.youhort
 */
public class ChassisNumberComboBox extends ComboBox {
	...
	public ChassisNumberComboBox(List<Asset> assets) {
		this(null, assets);
	}
    /**
     * @param caption
     ...
     * @param emptyLabel
     */
    public ChassisNumberComboBox(final String caption, List<Asset> asset, String emptyLabel) {
        super(caption);
    	...
    	if (assets != null  && !assets.isEmpty()) {
        	...
        	for (Asset asset : assets) {
        		if(asset.getEngineNumber() != null){
        			...
        			setItemCaption(asset.getId().toString(), asset.getChassisNumber());
     ...
     * @param dealers
     */
    public ChassisNumberComboBox(final String caption, List<Asset> assets) {
