 ...
 */
@Entity
@Table(name = "tu_asset_matrix_price")
public class AssetMatrixPrice extends EntityA {
    ...
    @Column(name = "ass_mat_pri_id", unique = true, nullable = false)
    public Long getId() {
        return id;
    }
	 ...
	 * @return the year
	 */
	@Column(name = "ass_mat_pri_nu_year", nullable = true)
	 ...
	 */
	@Column(name = "ass_mat_pri_am_ti_price_usd", nullable = true)
	 ...
	 */
	@Column(name = "ass_mat_pri_am_te_price_usd", nullable = true)
	 ...
	 */
	@Column(name = "ass_mat_pri_am_vat_price_usd", nullable = true)
	 ...
	 * @return the date
	 */
	@Column(name = "ass_mat_pri_dt_date", nullable = true)
	public Date getDate() {
		return date;
	}
