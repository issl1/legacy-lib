 ...
 */
@Entity
@Table(name = "td_individual_contact_info")
public class IndividualContactInfo extends EntityA {
	 ...
	 * @return
	 */
	public static IndividualContactInfo createInstance() {
		IndividualContactInfo contactInfo = EntityFactory.createInstance(IndividualContactInfo.class);
        return contactInfo;
    }
