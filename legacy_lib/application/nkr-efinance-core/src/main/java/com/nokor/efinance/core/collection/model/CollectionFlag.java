 ...
 */
@Entity
@Table(name = "td_collection_flag")
public class CollectionFlag extends EntityA implements MCollectionFlag {
     ...
     * @return
     */
    public static CollectionFlag createInstance() {
    	CollectionFlag colFlag = EntityFactory.createInstance(CollectionFlag.class);
        return colFlag;
    }
	...
	@Column(name = "cnt_col_fla_id", unique = true, nullable = false)
	public Long getId() {
		return id;
	}	
	 ...
	 */
	@Column(name = "cnt_col_fla_requested_usr_login", nullable = true, length = 50)
	 ...
	 */
	@Column(name = "cnt_col_fla_approved_usr_login", nullable = true, length = 50)
	 ...
	 */
	@Column(name = "cnt_col_fla_rejected_usr_login", nullable = true, length = 50)
	 ...
	 */
	@Column(name = "cnt_col_fla_dt_requested", nullable = true)
	 ...
	 */
	@Column(name = "cnt_col_fla_dt_approved", nullable = true)
	 ...
	 */
	@Column(name = "cnt_col_fla_dt_rejected", nullable = true)
	 ...
	 * @return the reason
	 */
	@Column(name = "cnt_col_fla_reason", nullable = true)
