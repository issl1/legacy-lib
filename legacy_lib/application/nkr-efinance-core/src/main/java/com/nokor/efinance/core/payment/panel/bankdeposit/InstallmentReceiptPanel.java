...
@VaadinView(InstallmentReceiptPanel.NAME)
public class InstallmentReceiptPanel  extends AbstractTabsheetPanel implements View {
	/** */
	private static final long serialVersionUID = -1929551934421408575L;
	public static final String NAME = "installment.receipt";
	
	@Autowired
	private InstallmentReceiptsTablePanel receitpTablePanel;
	...
	public void PostConstruct() {
		super.init();
		receitpTablePanel.setMainPanel(this);
		getTabSheet().setTablePanel(receitpTablePanel);
	}
