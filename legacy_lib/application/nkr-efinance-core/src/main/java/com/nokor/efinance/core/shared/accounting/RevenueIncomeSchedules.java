 ...
 *
 */
public class RevenueIncomeSchedules implements Serializable {
	...
	private List<RevenueIncomeSchedule> schedules;
	private int runningCase;
	
	/**
	 * @param calculationParameter
	 */
	public RevenueIncomeSchedules(Date startDate, Date firstInstallmentDate, CalculationParameter calculationParameter) {
	 ...
	 */
	public List<RevenueIncomeSchedule> getSchedules() {
		return schedules;
	}
	 ...
	 */
	public void setSchedules(List<RevenueIncomeSchedule> schedules) {
	...
	public double getMonthyTotalRevenue() {
		...
		for (RevenueIncomeSchedule schedule : schedules) {
