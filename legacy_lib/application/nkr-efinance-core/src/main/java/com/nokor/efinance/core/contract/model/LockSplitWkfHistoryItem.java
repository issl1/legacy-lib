 ...
 */
@Entity
@Table(name = "td_lock_split_wkf_history_item")
public class LockSplitWkfHistoryItem extends WkfBaseHistoryItem  {
    ...
    @Override
    public LockSplitWkfHistory getWkfHistory() {
		return (LockSplitWkfHistory) super.getWkfHistory();
	}
