 ...
 * @author ly.youhort
 */
public class PlateNumberComboBox extends ComboBox {
	...
	public PlateNumberComboBox(List<Asset> assets) {
		this(null, assets);
	}
    /**
     * @param caption
     ...
     * @param emptyLabel
     */
    public PlateNumberComboBox(final String caption, List<Asset> asset, String emptyLabel) {
        super(caption);
    	...
    	if (assets != null  && !assets.isEmpty()) {
        	...
        	for (Asset asset : assets) {
        		if(asset.getEngineNumber() != null){
        			...
        			setItemCaption(asset.getId().toString(), asset.getPlateNumber());
     ...
     * @param dealers
     */
    public PlateNumberComboBox(final String caption, List<Asset> assets) {
