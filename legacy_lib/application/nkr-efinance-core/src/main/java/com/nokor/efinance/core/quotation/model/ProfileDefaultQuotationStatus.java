 ...
 */
@Entity
@Table(name = "tu_profile_default_quotation_status")
public class ProfileDefaultQuotationStatus extends EntityA {
	
	private static final long serialVersionUID = 170123392304816515L;
    ...
    @Column(name = "pro_def_quo_sta_id", unique = true, nullable = false)
	public Long getId() {
		return id;
	}
