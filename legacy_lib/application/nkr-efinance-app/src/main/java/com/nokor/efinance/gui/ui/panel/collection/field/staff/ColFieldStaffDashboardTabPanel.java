 ...
 *
 */
public class ColFieldStaffDashboardTabPanel extends VerticalLayout implements ClickListener, FinServicesHelper {
	 ...
	 * 
	 */
	public ColFieldStaffDashboardTabPanel(ColFieldStaffPanel colFieldStaffPanel) {
		this.colFieldStaffPanel = colFieldStaffPanel;
		setSpacing(true);
		setMargin(true);
	...
	public void buttonClick(ClickEvent event) {
		if (event.getButton() == btnSeeAll) {
			if (colFieldStaffPanel != null) {
				colFieldStaffPanel.getFieldStaffTabSheet().setSelectedTab(colFieldStaffPanel.getTaskPanel());
			}
		}
	}
}
