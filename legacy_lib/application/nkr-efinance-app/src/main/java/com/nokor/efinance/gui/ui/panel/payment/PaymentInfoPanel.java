...
import com.nokor.efinance.core.payment.panel.earlysettlement.GLFInstallmentReceipt;
 ...
 *
 */
public class PaymentInfoPanel extends VerticalLayout implements FMEntityField {
	...
	public void assignValues(Payment payment) {
		...
		txtPaymentAmount.setValue(AmountUtils.format(installment+installmentOther+penaltyAmount));
