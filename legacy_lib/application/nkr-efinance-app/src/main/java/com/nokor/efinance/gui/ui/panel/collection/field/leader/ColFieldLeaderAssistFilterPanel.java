...
public class ColFieldLeaderAssistFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {
	 ...
	 * @param profileCode
	 */
	public ColFieldLeaderAssistFilterPanel(CollectionContractTablePanel tablePanel, String profileCode) {
		super(tablePanel);
