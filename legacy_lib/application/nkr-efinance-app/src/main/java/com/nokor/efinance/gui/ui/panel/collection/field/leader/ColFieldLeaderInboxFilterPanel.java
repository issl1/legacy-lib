...
public class ColFieldLeaderInboxFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {
	...
	public ColFieldLeaderInboxFilterPanel(CollectionContractTablePanel tablePanel, String profileCode) {
		super(tablePanel);
