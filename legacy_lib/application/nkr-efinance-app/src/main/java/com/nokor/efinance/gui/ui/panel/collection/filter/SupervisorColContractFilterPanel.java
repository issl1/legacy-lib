 ...
 * @author uhout.cheng
 */
public class SupervisorColContractFilterPanel extends AbstractContractFilterPanel implements MCollection, ValueChangeListener, FinServicesHelper {
	 ...
	 * @param profileCode
	 */
	public SupervisorColContractFilterPanel(final ColContractTablePanel contractTablePanel, String profileCode) {
	...
	protected Component createForm() {
		...
		btnSelect.addClickListener(new ClickListener() {
			/** */
			private static final long serialVersionUID = -8146127280022186995L;
			/**
	...
	private void showUsersSelectPanel() {
		...
		usersSelectPanel.show(new String[] {this.profileCode}, new UsersSelectPanel.Listener() {				
	...
	public ContractRestriction getRestrictions() {
		...
		if (selectUsers == null || selectUsers.isEmpty()) {			
			selectUsers = COL_SRV.getCollectionUsers(new String[] {this.profileCode}); 
		}
