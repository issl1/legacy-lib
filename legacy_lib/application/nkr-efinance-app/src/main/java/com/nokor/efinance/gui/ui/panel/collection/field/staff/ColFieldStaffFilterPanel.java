 ...
 *
 */
public class ColFieldStaffFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection {
	...
	public ColFieldStaffFilterPanel(CollectionContractTablePanel tablePanel) {
		super(tablePanel);
