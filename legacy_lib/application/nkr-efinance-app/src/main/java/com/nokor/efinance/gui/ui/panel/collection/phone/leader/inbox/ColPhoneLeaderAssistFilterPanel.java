 ...
 *
 */
public class ColPhoneLeaderAssistFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {

	/**
	 * 
	 */
	private static final long serialVersionUID = -110583877958711250L;
	 ...
	 * @param tablePanel
	 */
	public ColPhoneLeaderAssistFilterPanel(CollectionContractTablePanel tablePanel) {
		super(tablePanel);
	...
	public BaseRestrictions<ContractUserInbox> getRestrictions() {
		...
		restrictions.addCriterion(Restrictions.isNotNull("col.lastCollectionAssist"));
