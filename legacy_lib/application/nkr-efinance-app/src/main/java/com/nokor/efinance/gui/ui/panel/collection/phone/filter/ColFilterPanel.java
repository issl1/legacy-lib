 ...
 *
 */
public class ColFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection {

	private static final long serialVersionUID = -7449341535879943839L;
	
	public ColFilterPanel(CollectionContractTablePanel tablePanel) {
		super(tablePanel);
	}
