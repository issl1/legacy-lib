...
public class CallCenterStaffFilterPanel extends AbstractCollectionContractFilterPanel implements FinServicesHelper, MCollection {

	private static final long serialVersionUID = -4236733843062157847L;
	
	private CollectionContractTablePanel tablePanel;
	
	public CallCenterStaffFilterPanel(CollectionContractTablePanel tablePanel) {
		super(tablePanel);
