...
/**
 * The Report on ratio of application rejected to total application
 * @author bunlong.taing
 *
 */
@Component
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
@VaadinView(RatioNumApplicationRejectToTotalApplicant.NAME)
public class RatioNumApplicationRejectToTotalApplicant extends AbstractTabPanel implements View, QuotationEntityField, FrmkServicesHelper {

	/** */
	private static final long serialVersionUID = -3588186445280735979L;
	public static final String NAME = "ratio.num.app.rej.to.num.app";
	...
	protected com.vaadin.ui.Component createForm() {
		...
		cbxDealerType.addValueChangeListener(new ValueChangeListener() {
			/** */
			private static final long serialVersionUID = 6378068200358867299L;
			@Override
		...
		tableRatio.setCaption(I18N.message("numbers.application.rej.to.total.application"));
		...
		tabSheet.addTab(contentLayout, I18N.message("numbers.application.rej.to.total.application"));
	 ...
	 * @return The list of ColumnDefinition
	 */
	private List<ColumnDefinition> createColumnDefinitions() {
		List<ColumnDefinition> columnDefinitions = new ArrayList<ColumnDefinition>();
		
		columnDefinitions.add(new ColumnDefinition(MONTH, I18N.message("month"), String.class, Align.LEFT, 100));
		columnDefinitions.add(new ColumnDefinition(RATIO, I18N.message("ratio.application.rejected"), String.class, Align.LEFT, 300));
	 ...
	 * @return The button click listener
	 */
	private Button.ClickListener getButtonClickListener() {
		return new Button.ClickListener() {
			/** */
			private static final long serialVersionUID = 6458007213395061083L;
			@Override
	...
	private void onSearch() {
		...
		for (int i = 0; i < numberOfMonth; i++) {
			...
			long numApplicationRejected = getNbApplicationsFromBeginOfMonth(searchDate, dealer, dt, true);
			...
			double ratio = numApplication == 0 ? 0 : ((double) numApplicationRejected / numApplication) * 100;
	...
	/**
	 * Get the number of application from the beginning of the month
	 * @param date The date to be searched
	 * @param dealer The dealer to be searched
	 * @param needRejected whether the application needed is rejected
	 * @return The number of application
	 */
	private long getNbApplicationsFromBeginOfMonth(Date date, Dealer dealer, EDealerType dt, boolean needRejected) {
		...
		restrictions.addCriterion(Restrictions.ge("quotationDate", DateUtils.getDateAtBeginningOfDay(date)));
		restrictions.addCriterion(Restrictions.le("quotationDate", DateUtils.getDateAtEndOfDay(date)));
		if (dealer != null) {
