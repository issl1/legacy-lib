 ...
 *
 */
public class PaidOffAdjustmentReportSearchPanel extends AbstractSearchPanel<Contract> implements ContractEntityField {
	...
	public PaidOffAdjustmentReportSearchPanel(PaidOffAdjustmentReportTablePanel paidOffAdjustmentReportTablePanel) {
		super(I18N.message("search"), paidOffAdjustmentReportTablePanel);
	}
	...
	protected Component createForm() {
		...
		cbxDealerType.addValueChangeListener(new ValueChangeListener() {
			/** */
			private static final long serialVersionUID = 3393276776814187238L;
			@Override
	...
	public BaseRestrictions<Contract> getRestrictions() {
		...
		restrictions.addCriterion(Restrictions.eq("histo.hisReason", ContractHistoReason.CONTRACT_0003));
