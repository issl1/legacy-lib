 ...
 */
public class UnassignedManualPanel extends Window implements ClickListener, FinServicesHelper {
	/** */
	...
	private PhoneUnassignedOdmPanel mainPanel;
	 ...
	 * @param mainPanel
	 */
	public UnassignedManualPanel(PhoneUnassignedOdmPanel mainPanel, EColType colType) {
