 ...
 * @author uhout.cheng
 */
public class OutsourceAgencyUnassignedManualPanel extends Window implements ClickListener, FinServicesHelper {
	...
	private OutsourceAgencyUnassignedOdmPanel mainPanel;
	 ...
	 * @param colType
	 */
	public OutsourceAgencyUnassignedManualPanel(OutsourceAgencyUnassignedOdmPanel mainPanel, EColType colType) {
	...
	public void assignValues(int totalNbContract, SecUser selectedStaff) {
		...
		if (totalNbContract > 0 && selectedStaff != null) {
			...
			List<SecUser> staffs = COL_SRV.getCollectionUsers(profiles);
			if (!staffs.isEmpty()) {
