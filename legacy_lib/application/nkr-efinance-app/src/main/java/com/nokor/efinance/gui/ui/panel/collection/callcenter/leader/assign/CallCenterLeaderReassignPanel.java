...
/**
 * Call Center Leader Reassign Panel
 * @author uhout.cheng
 */
public class CallCenterLeaderReassignPanel extends Window implements ClickListener, FinServicesHelper {
	
	/** */
	private static final long serialVersionUID = 8281232507541361372L;
	...
	private CallCenterAssignedPanel mainPanel;
	
	/**
	 * 
	 * @param mainPanel
	 */
	public CallCenterLeaderReassignPanel(CallCenterAssignedPanel mainPanel) {
	...
	private GridLayout createTopLayout() {
		...
		cbxStaff.addValueChangeListener(new ValueChangeListener() {
			...
			/** */
			private static final long serialVersionUID = -7472237229048600043L;
		...
		txtNbContracts.addValueChangeListener(new ValueChangeListener() {
			...
			/** */
			private static final long serialVersionUID = -4458184709198475010L;
	...
	public void setStaffTableContainerDataSource() {
		...
		for (SecUser user : reassignStaffs.keySet()) {
			...
			btnRemove.addClickListener(new ClickListener() {
				...
				/** */
				private static final long serialVersionUID = -8289403657570232091L;
	...
	private void reassign() {
		ConfirmDialog confirmDialog = ConfirmDialog.show(UI.getCurrent(), I18N.message("confirm.reassign"), new ConfirmDialog.Listener() {
			...
			/** */
			private static final long serialVersionUID = -3902397910191216085L;
