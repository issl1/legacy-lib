 ...
 *
 */
public class ColPhoneStaffDashboardTabPanel extends AbstractControlPanel implements FinServicesHelper {
	...
	private int nbContractFollowup = 0;
	private int nbCollectionAssistPendding = 0;
	private int nbCollectionFlagPendding = 0;
	private int nbCollectionAssistReject = 0;
	private int nbCollectionFlagReject = 0;
	private int nbContractUnProcessed = 0;
	private int nbContractReturnRepoPendding = 0;
	private int nbContractReturnRepoAlready = 0;
	private int nbContractWithPromise = 0;
	private int nbContractNoOverdue = 0;
	private int nbCollectionFlagValidated = 0;
	private int nbCollectionAssistValidated = 0;
