...
import com.nokor.frmk.vaadin.ui.widget.table.impl.AbstractPagedTable;
...
import com.nokor.frmk.vaadin.util.exporter.PdfExporter;
 ...
 *
 */
public class PagedTable<T extends Entity> extends AbstractPagedTable<T> {
     ...
     * @param columns
     */
    public PagedTable(List<ColumnDefinition> columns) {
        this(null, columns);
    }
     ...
     * @param columns
     */
    public PagedTable(String caption, List<ColumnDefinition> columns) {
        super(caption);
        setPageLength(10);
    ...
    protected String formatPropertyValue(Object rowId, Object colId, Property property) {
        ...
        if (value instanceof Date) {
        	...
        	if (amountValue != null && amountValue.getTiAmount() != null) {
        		return AmountUtils.format(amountValue.getTiAmount());
        	}
        	return null;
        }
    ...
    public HorizontalLayout createExportBar() {
        ...
        //****
        final Button pdfExporter = new Button("", new ClickListener() {
			private static final long serialVersionUID = -7152634450251542091L;
			public void buttonClick(ClickEvent event) {
            	final PdfExporter pdfExp = new PdfExporter();
                pdfExp.setContainerToBeExported(container);
                pdfExp.sendConvertedFileToUser(getUI());
            }
        });
        pdfExporter.setIcon(new ThemeResource("../nkr-default/icons/16/pdf.png"));
        pdfExporter.setStyleName(Reindeer.BUTTON_LINK);
        //****
        
        
        exportBar.addComponent(excelExporter);
        exportBar.addComponent(csvExporter);
        exportBar.addComponent(pdfExporter);
