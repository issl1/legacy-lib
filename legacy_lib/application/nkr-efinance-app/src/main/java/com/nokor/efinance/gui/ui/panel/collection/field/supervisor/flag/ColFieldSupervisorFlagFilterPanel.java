 ...
 * @author uhout.cheng
 */
public class ColFieldSupervisorFlagFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection {

	/** */
	private static final long serialVersionUID = -2756980432346338686L;
	 ...
	 * @param tablePanel
	 */
	public ColFieldSupervisorFlagFilterPanel(CollectionContractTablePanel tablePanel) {
		super(tablePanel);
	...
	public BaseRestrictions<ContractUserInbox> getRestrictions() {
		...
		restrictions.addCriterion(Restrictions.eq("flag" + ".colType", EColType.FIELD));
