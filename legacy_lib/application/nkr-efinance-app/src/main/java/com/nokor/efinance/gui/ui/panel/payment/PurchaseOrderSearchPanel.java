 ...
 *
 */
public class PurchaseOrderSearchPanel extends AbstractSearchPanel<Payment> implements FMEntityField {
	...
	public PurchaseOrderSearchPanel(PurchaseOrderTablePanel purchaseOrderTablePanel) {
		super(I18N.message("search"), purchaseOrderTablePanel);
	}
	...
	protected Component createForm() {
		...
		valueChangeListener = new ValueChangeListener() {
			/** */
			private static final long serialVersionUID = 4425215043018404924L;
			@Override
	...
	public BaseRestrictions<Payment> getRestrictions() {
		...
		restrictions.addCriterion(Restrictions.or(
				Restrictions.lt("printPurchaseOrderVersion", 1),
				Restrictions.isNull("printPurchaseOrderVersion")));
