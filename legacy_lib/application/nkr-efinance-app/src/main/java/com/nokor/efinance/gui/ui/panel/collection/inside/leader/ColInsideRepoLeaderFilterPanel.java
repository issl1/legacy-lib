...
public class ColInsideRepoLeaderFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {
	...
	public ColInsideRepoLeaderFilterPanel(CollectionContractTablePanel tablePanel, String profileCode) {
		super(tablePanel);
