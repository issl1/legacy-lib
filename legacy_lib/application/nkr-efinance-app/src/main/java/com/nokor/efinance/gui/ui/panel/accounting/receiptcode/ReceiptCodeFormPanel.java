...
public class ReceiptCodeFormPanel extends AbstractFormPanel {

	/** */
	private static final long serialVersionUID = -6467312256410653221L;
	...
	protected Entity getEntity() {
		journalEvent.setJournal(ENTITY_SRV.getById(Journal.class, JournalEvent.RECEIPTS));
