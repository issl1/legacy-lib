...
import com.nokor.efinance.gui.report.xls.GLFThreeHours;
...
@VaadinView(ThreeHoursReportPanel.NAME)
public class ThreeHoursReportPanel extends AbstractReportPanel {

	private static final long serialVersionUID = -8173918126351309900L;

	public static final String NAME = "three.hours.report";
	...
	protected AbstractSearchReportPanel createSearchPanel() {
		return new ThreeHoursReportSearchPanel();
	}

	@Override
	protected Class<? extends Report> getReportClass() {
		return GLFThreeHours.class;
	}
