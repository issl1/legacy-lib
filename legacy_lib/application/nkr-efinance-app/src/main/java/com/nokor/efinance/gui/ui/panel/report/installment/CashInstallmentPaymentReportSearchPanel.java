 ...
 *
 */
public class CashInstallmentPaymentReportSearchPanel extends AbstractSearchPanel<Payment> implements FMEntityField {
	 ...
	 */
	public CashInstallmentPaymentReportSearchPanel(CashInstallmentPaymentReportTablePanel installmentPaymentReportTablePanel) {
	...
	protected Component createForm() {
        ...
        gridLayout.addComponent(ComponentFactory.getSpaceLayout(10, Unit.PIXELS), iCol++, 1);
        gridLayout.addComponent(new Label(I18N.message("payment.method")), iCol++, 1);
        gridLayout.addComponent(cbxPaymentMethod, iCol++, 1);
	...
	public BaseRestrictions<Payment> getRestrictions() {
		...
		if (cbxPaymentMethod.getSelectedEntity() != null) {
			restrictions.addCriterion(Restrictions.eq("paymentMethod", cbxPaymentMethod.getSelectedEntity()));
		}
		...
		if (ProfileUtil.isPOS() && usrDetail1.getDealer() != null) {
			restrictions.addCriterion(Restrictions.eq(DEALER + "." + ID, usrDetail1.getDealer().getId()));
		} else {
			if (cbxDealer.getSelectedEntity() != null) {
