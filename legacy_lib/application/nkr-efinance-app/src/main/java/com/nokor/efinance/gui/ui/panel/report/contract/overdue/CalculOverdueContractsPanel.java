...
@VaadinView(CalculOverdueContractsPanel.NAME)
public class CalculOverdueContractsPanel extends Panel implements View {

	/** */
	private static final long serialVersionUID = -7397440003540163018L;
	
	public static final String NAME = "calculate.overdue.contracts";
	
	private ContractOtherDataService contractOtherDataService = SpringUtils.getBean(ContractOtherDataService.class);
	...
	public void PostConstruct() {
		...
		Button btnCalculate = new Button(I18N.message("calculate"));
