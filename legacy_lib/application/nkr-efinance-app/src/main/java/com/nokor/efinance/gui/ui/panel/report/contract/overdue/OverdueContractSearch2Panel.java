 ...
 */
public class OverdueContractSearch2Panel extends AbstractSearchPanel<Contract> implements FMEntityField {
	...
	public BaseRestrictions<Contract> getRestrictions() {
		...
		if (cbxDealer.getSelectedEntity() != null) {
			restrictions.addCriterion(Restrictions.eq("quo.dealer", cbxDealer.getSelectedEntity()));
		}
		...
		if (cbxDistrict.getSelectedEntity() != null) {
			...
			restrictions.addAssociation("appaddr.address", "addr", JoinType.INNER_JOIN);			
			restrictions.addCriterion("appaddr.addressType", ETypeAddress.MAIN);
			restrictions.addCriterion("addr.district.id", cbxDistrict.getSelectedEntity().getId());
		}
