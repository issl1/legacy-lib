 ...
 * @author uhout.cheng
 */
public class ColFieldSupervisorAssistFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {

	/** */
	private static final long serialVersionUID = 2479868307907247550L;
	 ...
	 * @param profileCode
	 */
	public ColFieldSupervisorAssistFilterPanel(CollectionContractTablePanel tablePanel, String profileCode) {
		super(tablePanel);
	...
	public BaseRestrictions<ContractUserInbox> getRestrictions() {
		...
		restrictions.addCriterion(Restrictions.eq("ass" + ".colType", EColType.FIELD));
