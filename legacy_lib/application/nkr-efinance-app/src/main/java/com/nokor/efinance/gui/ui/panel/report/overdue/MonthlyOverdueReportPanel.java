...
import com.nokor.efinance.gui.report.xls.GLFMonthlyOverdue;
...
@VaadinView(MonthlyOverdueReportPanel.NAME)
public class MonthlyOverdueReportPanel extends AbstractReportPanel {

	private static final long serialVersionUID = -8173918126351309900L;

	public static final String NAME = "monthly.overdue.report";
	...
	protected AbstractSearchReportPanel createSearchPanel() {
		return new MonthlyOverdueReportSearchPanel();
	}

	@Override
	protected Class<? extends Report> getReportClass() {
		return GLFMonthlyOverdue.class;
	}
