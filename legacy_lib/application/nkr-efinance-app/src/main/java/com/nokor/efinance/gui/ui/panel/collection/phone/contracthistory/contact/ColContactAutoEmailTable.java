 ...
 *
 */
public class ColContactAutoEmailTable extends Panel {

	/** */
	private static final long serialVersionUID = 4340989389561788920L;
	
	private SimpleTable<Entity> simpleTableAutoEmail;
	
	public ColContactAutoEmailTable() {
		init();
	}
	 ...
	 */
	private void init() {
		simpleTableAutoEmail = new SimpleTable<Entity>(getAutoEmailColumnDefinitions());
		simpleTableAutoEmail.setPageLength(5);
		setStyleName(Reindeer.PANEL_LIGHT);
		setContent(simpleTableAutoEmail);
	}
	 ...
	 */
	private List<ColumnDefinition> getAutoEmailColumnDefinitions() {
