...
import com.nokor.efinance.gui.report.xls.GLFQuotations;
...
@VaadinView(QuotationsReportPanel.NAME)
public class QuotationsReportPanel extends AbstractReportPanel {

	private static final long serialVersionUID = -8173918126351309900L;

	public static final String NAME = "quotations.report";
	...
	protected AbstractSearchReportPanel createSearchPanel() {
		return new QuotationReportSearchPanel();
	}

	@Override
	protected Class<? extends Report> getReportClass() {
		return GLFQuotations.class;
	}
