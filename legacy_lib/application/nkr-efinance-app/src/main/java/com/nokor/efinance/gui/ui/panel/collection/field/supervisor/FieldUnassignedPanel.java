...
/**
 * Field Unassigned Panel
 * @author bunlong.taing
 */
public class FieldUnassignedPanel extends AbstractTabPanel implements FinServicesHelper {
	/** */
...
//	private ResultsTablePanel resultsTablePanel;
	...
	public FieldUnassignedPanel() {
		...
		btnReassign.addClickListener(new ClickListener() {			
			...
			public void buttonClick(ClickEvent event) {
				COL_SRV.reassignFieldContracts();
	...
	private Panel createAssignmentTableDetailLayout() {
		...
		for (String type : types) {
			...
			template += "<tr><td>" + type + "</td><td " + location1 + "\"></td><td " + location2 + "\"></td><td " + location3 + "\"></td><td " + location4 + "\"></td><td " + location5 + "\"></td></tr>";
		}
		template += "</table>";
	...
	public void calculateDetailData() {
		int odmsUnassigned[] = new int[5];
		int odmsAssigned[] = new int[5];
		int odmsStaffAllocated[] = new int[5];
	...
	private TabSheet createTabLayout() {
		...
		resourcesPanel = new ResourcesCollectionPanel(EColType.FIELD);
		
		odm1Tab = new PhoneUnassignedOdmPanel(DebtLevelUtils.DEBT_LEVEL_1, EColType.FIELD);
		odm2Tab = new PhoneUnassignedOdmPanel(DebtLevelUtils.DEBT_LEVEL_2, EColType.FIELD);
		odm3Tab = new PhoneUnassignedOdmPanel(DebtLevelUtils.DEBT_LEVEL_3, EColType.FIELD);
		odm4Tab = new PhoneUnassignedOdmPanel(DebtLevelUtils.DEBT_LEVEL_4, EColType.FIELD);
		odm5Tab = new PhoneUnassignedOdmPanel(DebtLevelUtils.DEBT_LEVEL_5, EColType.FIELD);
