...
/**
 * Payment received table in collection right panel 
 * @author uhout.cheng
 */
public class PaymentsReceivedTablePanel extends Panel implements FinServicesHelper {
	
	/** */
	private static final long serialVersionUID = -6240185977193166135L;
	 ...
	 * 
	 */
	public PaymentsReceivedTablePanel() {
	...
	private SimpleTable<Entity> getSimpleTable(List<ColumnDefinition> columnDefinitions) {
		...
		simpleTable.setWidth(525, Unit.PIXELS);
	...
	private void init() {
		...
		setCaption(I18N.message("payments.received"));
	}
