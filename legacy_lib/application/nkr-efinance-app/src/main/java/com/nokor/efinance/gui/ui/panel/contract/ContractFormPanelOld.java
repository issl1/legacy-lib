...
public class ContractFormPanelOld extends AbstractFormPanel {
	...
	protected com.vaadin.ui.Component createForm() {
		...
		// accordionPanel.addTab(detailPanel, I18N.message("detail"));
	 ...
	 * @author ly.youhort
	 */
	private class FMCommandContract implements Command {
		private static final long serialVersionUID = -318686375997563234L;
		private String viewName = "";
		/**
		 * 
		 * @param viewName
		 */
		public FMCommandContract(String viewName) {
			this.viewName = viewName;
		}
		
		@Override
		public void menuSelected(MenuItem selectedItem) {
			Page.getCurrent().setUriFragment("!" + viewName + "/" + contract.getId());
		}
	}
	/**
	 * @author vina.sok
