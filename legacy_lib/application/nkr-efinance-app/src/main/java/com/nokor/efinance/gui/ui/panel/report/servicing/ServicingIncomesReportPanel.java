...
@VaadinView(ServicingIncomesReportPanel.NAME)
public class ServicingIncomesReportPanel extends AbstractTabPanel implements View, ContractEntityField, FrmkServicesHelper {
	...
	public ServicingIncomesReportPanel() {
		super();
		setSizeFull();
	}
