 ...
 *
 */
public class ColInsideRepoStaffDashboardTabPanel extends VerticalLayout implements ClickListener, FinServicesHelper {
	 ...
	 * 
	 */
	public ColInsideRepoStaffDashboardTabPanel(ColInsideRepoStaffPanel colInsideRepoStaffPanel) {
		this.colInsideRepoStaffPanel = colInsideRepoStaffPanel;
		setSpacing(true);
		setMargin(true);
	...
	public void buttonClick(ClickEvent event) {
		if (event.getButton() == btnSeeAll) {
			if (colInsideRepoStaffPanel != null) {
				colInsideRepoStaffPanel.getStaffTabSheet().setSelectedTab(colInsideRepoStaffPanel.getTaskTabPanel());
			}
		}
	}
}
