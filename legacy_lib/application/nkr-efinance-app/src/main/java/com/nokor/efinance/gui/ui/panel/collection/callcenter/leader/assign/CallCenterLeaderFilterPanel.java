...
public class CallCenterLeaderFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {
	 ...
	 * @param profileCode
	 */
	public CallCenterLeaderFilterPanel(CollectionContractTablePanel tablePanel, String profileCode) {
		super(tablePanel);
