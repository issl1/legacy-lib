...
public class UnpaidPPVsPRReportSearchPanel extends AbstractSearchReportPanel implements QuotationEntityField {
	...
	public UnpaidPPVsPRReportSearchPanel() {
	...
	protected Component createForm() {
		...
		valueChangeListener = new ValueChangeListener() {
			/** */
			private static final long serialVersionUID = -7988644504267997835L;
			@Override
