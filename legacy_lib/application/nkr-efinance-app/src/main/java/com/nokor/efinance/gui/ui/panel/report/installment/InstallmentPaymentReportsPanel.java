...
@VaadinView(InstallmentPaymentReportsPanel.NAME)
public class InstallmentPaymentReportsPanel extends AbstractTabsheetPanel implements View, CashflowEntityField, PaymentEntityField {
	
	private static final long serialVersionUID = 1921078497711712192L;

	public static final String NAME = "report.installment.payments";
	
	private EntityService entityService = (EntityService) SecApplicationContextHolder.getContext().getBean("entityService");
	
	@Autowired
	private InstallmentPaymentReportTablePanel installmentPaymentReportTablePanel;
	...
	public void onEditEventClick() {
		payment = entityService.getById(Payment.class, installmentPaymentReportTablePanel.getItemSelectedId());
	...
	public void redirectToSecondPaymentTable() {
		installmentPaymentReportTablePanel.refresh();
		getTabSheet().setSelectedTab(installmentPaymentReportTablePanel);
	}
}
