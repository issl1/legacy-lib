 ...
 *
 */
public class ColPhoneLeaderInboxFilterPanel extends AbstractCollectionContractFilterPanel implements MCollection, FinServicesHelper {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6210635098869685768L;
	
	private CollectionContractTablePanel tablePanel;
	
	private String profileCode;

	public ColPhoneLeaderInboxFilterPanel(CollectionContractTablePanel tablePanel, String profileCode) {
		super(tablePanel);
