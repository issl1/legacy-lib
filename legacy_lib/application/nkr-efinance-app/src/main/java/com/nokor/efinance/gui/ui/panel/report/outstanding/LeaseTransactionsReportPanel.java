...
@VaadinView(LeaseTransactionsReportPanel.NAME)
public class LeaseTransactionsReportPanel extends AbstractTabPanel implements View, ContractEntityField, FrmkServicesHelper {
	
	private static final long serialVersionUID = 8019051395954081483L;

	public static final String NAME = "lease.transactions.report";
	...
	public LeaseTransactionsReportPanel() {
		super();
		setSizeFull();
	}
	...
	private void search() {
		if (isValid()) {
			List<LeaseTransaction> revenues = accountingService
					.getLeaseTransactions(cbxDealerType.getSelectedEntity(),
