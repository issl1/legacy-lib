...
public class ReceiptCodeTablePanel extends AbstractTablePanel<JournalEvent> implements MJournalEvent, MEntityA{

	/** */
	private static final long serialVersionUID = 4735945965413974080L;
	...
	public void PostConstruct() {
		setCaption(I18N.message("receipt.codes"));
		setSizeFull();
		setMargin(true);
		setSpacing(true);
				
		super.init(I18N.message("receipt.codes"));
	 ...
	 */
	@Override
	protected ReceiptCodeSearchPanel createSearchPanel() {
		return new ReceiptCodeSearchPanel(this);
	}
}
