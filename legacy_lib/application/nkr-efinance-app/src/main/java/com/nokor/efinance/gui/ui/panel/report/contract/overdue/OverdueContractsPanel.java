...
@VaadinView(OverdueContractsPanel.NAME)
public class OverdueContractsPanel extends AbstractTabsheetPanel implements View {

	/** */
	private static final long serialVersionUID = -7397440003540163018L;
	public static final String NAME = "overdue.constracts";
	
	@Autowired
	private OverdueContractTablePanel tablePanel;
	@Autowired
	private OverdueContractFormPanel formPanel;
