 ...
 * @author uhout.cheng
 */
public class CollectionPenaltyPanel extends AbstractControlPanel implements ClickListener {
	...
	private CollectionPenaltyTablePanel penaltyTablePanel;
	
	/**
	 * 
	 */
	public CollectionPenaltyPanel() {
		init();
	}
	...
	private void init() {
		...
		penaltyTablePanel = new CollectionPenaltyTablePanel();
		...
		verLayout.addComponent(penaltyTablePanel);
		
		Panel mainPanel = new Panel();
		mainPanel.setCaption(I18N.message("penalty"));
	...
	public void buttonClick(ClickEvent event) {
		if (event.getButton().equals(btnHide)) {
			penaltyTablePanel.setVisible(!penaltyTablePanel.isVisible());
			btnHide.setCaption(!penaltyTablePanel.isVisible() ? I18N.message("show") : I18N.message("hide"));
		}
	}
