...
public class InstallmentPaymentReportSearchPanel extends AbstractSearchPanel<Payment> implements FMEntityField {
	...
	public InstallmentPaymentReportSearchPanel(FOInstallmentPaymentReportTablePanel installmentPaymentReportTablePanel) {
	...
	protected Component createForm() {
		...
		valueChangeListener = new ValueChangeListener() {
			/** */
			private static final long serialVersionUID = 3425000260418613784L;
			@Override
	...
	public BaseRestrictions<Payment> getRestrictions() {
		...
		if (cbxPaymentMethod.getSelectedEntity() != null) {
			restrictions.addCriterion(Restrictions.eq("paymentMethod.id", cbxPaymentMethod.getSelectedEntity().getId()));
		}
