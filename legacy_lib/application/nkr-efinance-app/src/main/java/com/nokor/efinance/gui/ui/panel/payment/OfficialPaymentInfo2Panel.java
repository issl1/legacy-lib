 ...
 *
 */
public class OfficialPaymentInfo2Panel extends VerticalLayout implements FMEntityField {
	...
	public OfficialPaymentInfo2Panel() {
		setMargin(true);
	...
	public void assignValues(Payment payment) {
		...
		txtPaymentAmount.setValue(AmountUtils.format(tiAdvancePaymentUsd + tiOtherUsd));
		txtSecondPayment.setValue(AmountUtils.format(financedAmountUsd + tiOtherUsd));
	}
